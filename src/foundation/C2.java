...
public class C2 {
	...
	public static void main(String[] args) throws Exception {
		...
		BigInteger c = new BigInteger("8701485697571629912108508730957703831688317541285382011555129355623048840582638" + 
		...
		//Manually using the RSA algorithm
		BigInteger m = c.modPow(d, n);
		System.out.println("PT from JCE:\t"+ new String (m.toByteArray()));
